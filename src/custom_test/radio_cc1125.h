// command strobes - 3.2.2 pg 14/111, swru295e
#include <stdint.h>

#define CC1125_SRES    (0x30) // reset chip
#define CC1125_SFSTXON (0x31) // enable and calibrate frequency synthesizer
#define CC1125_SXOFF   (0x32) // enter xoff when CSn de-assert
#define CC1125_SCAL    (0x33) // calibrate freq synth and turn it off
#define CC1125_SRX     (0x34) // enable RX
#define CC1125_STX     (0x35) // enable TX
#define CC1125_SIDLE   (0x36) // exit TX/RX, turn off synth
#define CC1125_SAFC    (0x37) // auto frequency compensation
#define CC1125_SWOR    (0x38) // start auto RX poll sequence
#define CC1125_SPWD    (0x39) // enter sleep when CSN de-assert
#define CC1125_SFRX    (0x3A) // flush RX FIFO
#define CC1125_SFTX    (0x3B) // flush TX FIFO
#define CC1125_SWORRST (0x3C) // reset eWOR timer
#define CC1125_SNOP    (0x3D) // no operation
