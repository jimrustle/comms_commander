/**
  ...
  * Brief    This code example shows how to read the device Id. 
  *
  ==============================================================================
 ...
 ===============================================================================
   ...
   - Green LED toggle if Id is correct
   - Red LED blinks in other case
  *    
  ******************************************************************************
  * Attention
  *
...
int main(void)
{
  ...
  /* The Id is check in the button IRQ */
...
__INLINE void CheckId(void)
{
  ...
  {
    error = ERROR_DBG; /* Report an error */
  }
}
