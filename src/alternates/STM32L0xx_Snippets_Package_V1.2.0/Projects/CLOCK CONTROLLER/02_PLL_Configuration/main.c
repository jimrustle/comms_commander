/**
 ...
 ===============================================================================
    ...
    - This example modifies the PLL to x6, so the blinking is faster
    - Once the PLL is enabled, the red LED is switched on.
      In case of error, the green LED is switched off 
      and the red LED blinks coding the error.
  *    
  ******************************************************************************
  * Attention
  *
...
/**
  * Brief   This function switches the system clock to 48MHz
  *         POWER SCALE   = RANGE 1
  *         SYSTEM CLOCK  = PLL MUL24 DIV2
  *         PLL SOURCE    = HSI/4
  *         FLASH LATENCY = 1
  *         The HSI is enabled and divided by 4.
  * Param   None
  * Retval  None
  */
