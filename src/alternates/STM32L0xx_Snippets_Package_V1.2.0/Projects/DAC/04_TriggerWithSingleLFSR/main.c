/**
  ******************************************************************************
  * File     04_TriggerWithSingleLFSR/main.c 
  * Author   MCD Application Team
  * Version  V1.2.0
  * Date     05-February-2016
  * Brief    This code example shows how to configure the DAC  
  *          in order to generate a pseudonoise.
 ===============================================================================
                    #####       MCU Resources     #####
 ===============================================================================
   - RCC
 ...
 ===============================================================================
    - The code performs the DAC configuration and provides data in order 
      to generate fixed signal on the DAC output PA4.
    - The DAC is configured to add pseudonoise thru the LFSR.
...
/**
  ...
  *         It configures the DAC channel WAVE1[1:0] bits as “01” 
  *         and the same LFSR mask value in the MAMP1[3:0] bits = 1000 for a 511-bits amplitude 
...
__INLINE void  ConfigureDAC(void)
{
  ...
  /* (2) Configure WAVE1 at 01 and LFSR mask amplitude (MAMP1) at 1000 for a 511-bits amplitude, 
         enable the DAC ch1,
