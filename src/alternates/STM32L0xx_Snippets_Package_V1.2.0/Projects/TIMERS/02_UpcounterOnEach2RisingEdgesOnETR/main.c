/**
 ...
 ===============================================================================
    - This example configures the TIM2 in order to increment the counter
      ...
      The GPIO PA0, corresponding to TIM2_ETR, is configured as alternate function 
      and the AFR5 is selected.
      To test this example, the user button is kept conected to PA0.
...
__INLINE void ConfigureTIMxForETR(void)
{
  ...
  /* (4) Select TIM2_ETR on PA0 by enabling AF5 for pin 0 in GPIOA AFRL register */ 
