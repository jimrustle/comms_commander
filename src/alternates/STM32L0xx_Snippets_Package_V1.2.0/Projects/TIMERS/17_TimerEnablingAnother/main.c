/**
 ...
 ===============================================================================
    - This example configures the TIM21 in master mode so that it enables the 
      ...
      TIM2_CH1 also.
      TIM21_CH1 PWM has a higher period than TIM2_CH1 which toggles at each count.
      To monitor the signals, use an oscilloscope on PB13 for TIM21_CH1 and PA5
      for TIM2_CH1. Signal on PA5 is not showing sharp rising edge due to the led
      and its pull-up connected on.
