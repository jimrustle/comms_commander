/**
 ...
 ===============================================================================
    - This example configures the TIM2 in order to reset the counter
...
void ConfigureTIMxInResetMode(void);
/* Private functions ---------------------------------------------------------*/
...
/**
  * Brief   This function configures the TIMx in reset mode.
  *         The timer is upcounting each 1ms.
  *         To use another timer, channel or GPIO, the RCC and GPIO configuration 
  *         must be adapted according to the datasheet.
  * Param   None
  * Retval  None
  */
__INLINE void ConfigureTIMxInResetMode(void)
{
