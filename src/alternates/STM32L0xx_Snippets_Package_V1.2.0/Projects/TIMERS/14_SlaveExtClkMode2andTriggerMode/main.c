/**
 ...
 ===============================================================================
   - RCC
   - TIMx
  - GPIO PA0 and PA5 for TIM2_CH1 and TIM2_ETR
  - GPIO PB5 for  green LED
 ...
 ===============================================================================
    - This example configures the TIM2 in order to start the counter in response 
      to a rising edge on TI1 input and counts the rising edges on the TIM2_ETR.
      The GPIO PA0 and PA5, corresponding to TIM2_CH1 and TIM2_ETR, are 
      configured as alternate function and the AFR2 is selected.
      To test this example, the user button is conected to PA0.
      A wave generator can be connected to TIM2_ETR.
      The count will start once pushing the user button.
      The TIM2 counter is loaded in a global variable named Counter which can be 
      monitored in live. The counter value is also used to toggle the green led 
	  each time the counter value is a multiple of 0x80. This allows to check 
...
__INLINE void ConfigureTIMxAsExtClkInTriggerMode(void)
{
  ...
  /* (4) Select AF2 on PA5 and PA0 in AFRL for TIM2_CH1 and TIM2_ETR */
