/**
 ...
 ===============================================================================
    - This example configures the TIM21 in order to manage an external encoder
      ...
      The GPIO PB13 and PB14, corresponding respectively to TIM21_CH1 and TIM21_CH2, 
      are configured as alternate function and the AFR6 is selected.
    ...
    - This example can be tested using dual-channel function generator, with a 
      low frequency. The red led will blink each 2s coding the counter as 
