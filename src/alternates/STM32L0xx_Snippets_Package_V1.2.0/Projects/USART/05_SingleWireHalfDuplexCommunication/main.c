/**
 ...
 ===============================================================================
   - RCC
   - GPIO PA9(USART1_TX),PA0,PA5,PB4
   - USART1
   - EXTI
...
/**
  * Brief   This function :
             - Enables GPIO clock
             - Configures the USART1 pins on GPIO PA9
  * Param   None
  * Retval  None
  */
__INLINE void Configure_GPIO_USART1(void)
{
  ...
  /* (1) Select AF mode (10) on PA9 */
  /* (2) AF4 for USART1 signals */
  GPIOA->MODER = (GPIOA->MODER & ~GPIO_MODER_MODE9) | (GPIO_MODER_MODE9_1); /* (1) */
  GPIOA->AFR[1] = (GPIOA->AFR[1] &~ (0x000000F0)) | (4 << (1 * 4)); /* (2) */
}
