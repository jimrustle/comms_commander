/**
 ...
 ===============================================================================
   ...
   - Send break character to switch off both LEDs
...
void USART1_IRQHandler(void)
{
  ...
  if((USART1->ISR & USART_ISR_LBD) == USART_ISR_LBD)
  {
  ...
  else if((USART1->ISR & USART_ISR_RXNE) == USART_ISR_RXNE)
  {
    ...
    {
    case 'g':
    case 'G': GPIOB->BSRR = (1 << 4); //switch on green led on PB4
              break;
    default: break;
    }
  }
  ...
  {
    error = ERROR_USART_LIN; /* Report an error */
